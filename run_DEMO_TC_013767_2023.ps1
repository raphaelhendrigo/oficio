...
# ============================================================================
# DEMO 2026-06-23 - TC/013767/2023 (UTAP) com Chrome VISIVEL
# Espelha run_DEMO_TC_008177_2023.ps1 trocando FORCE_TIPO de DILACAO para UTAP.
# Fluxo PROD completo (cleanup + oficio + comunicacao + Roseli, SEM tramitar).
# ============================================================================

$processo = "TC/013767/2023"
...
$env:FORCE_TIPO = "UTAP"
$env:EUCLIDES_JOB_ID = "demo_2026-06-23_TC013767_2023"

Set-Location -Path $PSScriptRoot
if (-not (Test-Path "logs")) { New-Item -ItemType Directory -Path "logs" | Out-Null }
$logPath = "logs\DEMO_TC_013767_2023_$((Get-Date).ToString('yyyyMMdd_HHmmss')).log"

Write-Host ""
Write-Host "==========================================================" -ForegroundColor Cyan
Write-Host " DEMO - TC/013767/2023 - UTAP - Chrome VISIVEL            " -ForegroundColor Cyan
