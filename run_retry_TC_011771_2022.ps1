...
# Retry isolado 2026-05-25 (TC/011771/2022 - Educacao, DILACAO):
...
#   Referencia = "Ofício nº 834/2026 - SME / COGEP / DITEM"
#   Oficio SSG = 13099/2025
...
$env:PROCESSOS_LIST = "TC/011771/2022"
$env:ONLY_PROCESSOS_AUTHORIZED = "TC/011771/2022"
...
$env:OFICIO_REFERENCIA_TEXT = "Ofício nº 834/2026 - SME / COGEP / DITEM"
$env:OFICIO_SSG_REF = "13099/2025"

Write-Host "[2/2] Retry isolado TC/011771/2022 (DILACAO Educacao, data 25/05/2026)..." -ForegroundColor Cyan
$ts = Get-Date -Format 'yyyyMMdd_HHmmss'
$logPath = "logs\run_retry_TC_011771_2022_$ts.log"
...
$ok = Select-String -Path $logPath -Pattern "Assinatura solicitada para .* no processo TC/011771/2022" -Quiet
if ($ok) { Write-Host "RESULTADO: TC/011771/2022 -> OK" -ForegroundColor Green; exit 0 }
else { Write-Host "RESULTADO: TC/011771/2022 -> FALHA (ver $logPath)" -ForegroundColor Red; exit 1 }
