...
# ============================================================================
# 2026-05-25 - 9 processos de REITERACAO (1 Saude + 8 Educacao)
# Origem: planilha Processos_25_05_2026.pdf, distribuidos para Raphael.
# TC/009208/2023 foi excluido pois ja foi concluido hoje.
#
# Fluxo completo PROD destrutivo + comm + Oficio SSG (REITERACAO, auto por
# secretaria) + concluido + assinatura Roseli Chaves, SEM tramitar.
# Data do Oficio: 25/05/2026. Prazo: 60 dias.
#
# FORCE_TIPO=REITERACAO (apos pytest). Auto-extracao por processo via
# _extract_reiteracao_data_from_pieces (SSG + data + pecas MANUTAP+DES).
# ============================================================================

$saude = @(
    "TC/006174/2024"  # Joao Antonio, SMS - Maria Gisele Hernand...
)
$educacao = @(
    "TC/006239/2023",  # Joao Antonio
    "TC/006139/2023",  # Joao Antonio
    "TC/005808/2023",  # Joao Antonio
    "TC/005684/2023",  # Joao Antonio
    "TC/005672/2023",  # Joao Antonio
    "TC/005656/2023",  # Joao Antonio
    "TC/005027/2023",  # Joao Antonio
    "TC/012248/2021"   # Roberto Braguim
)
$all = @($saude + $educacao)
...
# REITERACAO: template tem "Cópia da(s) peça(s) XX dos autos" -> precisa numero.
...
# Override REITERACAO + exige auto-extracao
...
for ($attempt = 1; $attempt -le $maxAttempts; $attempt++) {
    ...
    Write-Host "==================================================================" -ForegroundColor Yellow
    $logPath = "logs\run_9_REITERACAO_2026_05_25_${runTs}_attempt${attempt}.log"
...
$lines = @()
$lines += "RELATORIO - 9 PROCESSOS REITERACAO (1 SAUDE + 8 EDUCACAO) - $runTs"
$lines += "Data Oficio: 26/05/2026 | Prazo: 60 dias | Assinante: Roseli Chaves | SEM tramitar | PROD destrutivo"
$lines += "Tipo forcado: REITERACAO (auto-extracao obrigatoria)"
$lines += ""
...
$reportPath = "logs\RELATORIO_9_REITERACAO_2026_05_25_${runTs}.txt"
